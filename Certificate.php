...
<body>
  ...
  <nav class="navbar navbar-dark navbar-expand-lg bg-success">
    <div class="container-fluid">
      <a id="title" class="navbar-brand align-text-top m-auto text-lg-start text-wrap" href="Certificate.php">
  ...
  <!--pagecontext body with image-->
    ...
    <h1 class="centered1">We provide you with all the Skills you Need to travel the World</h1>
      <h2 class="centered2">With our Certificate you can apply to any Airport Job</h2>
        <h2 class="centered3">100% succes Rate Guarantee</h2>
      <h2 class="centered4">Accepted aorund the world</h2>
      <h2 class="centered3">From one of the best Teacher in her Field</h2>
      <h2 class="centered4">Learn Buisness Language</h2>
      <h2 class="centered2">Learn High Society Language</h2>
      <h2 class="centered4">For you and Us</h2>
      <h2 class="centered3">Only for Quality Workers</h2>
     </div>
